  ...
  <View style={styles.container}>
    <View>
      ...
      <Text onPress={()=>{
        ...
        //End of workaround
          props.navigation.navigate('Messages')}} style={styles.text}>Go to First</Text>
      <Text onPress={()=>props.navigation.navigate('Login')} style={styles.text}>Go to Second</Text>
      <Text onPress={()=>props.navigation.navigate('Faq')} style={styles.text}>Go to Third</Text>
    </View>
  </View>
)
